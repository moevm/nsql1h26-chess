...
def parse_args():
    ...
    parser.add_argument('--base-url', default=DEFAULT_BASE_URL,
                        help='API base URL, e.g. http://localhost:3000')
    parser.add_argument('--bot-id', required=False,
                        help='Bot player ID used in game listing query')
    ...
    if not args.bot_id:
        raise BotError('Bot ID is required. Use --bot-id or set BOT_ID environment variable.')
    if not args.bot_key:
